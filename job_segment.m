...
matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {'D:\spm12\tpm\TPM.nii,1'};
...
matlabbatch{2}.spm.spatial.preproc.tissue(2).tpm = {'D:\spm12\tpm\TPM.nii,2'};
...
matlabbatch{3}.spm.util.imcalc.outdir = {[b.dataDir b.anatT1]};
matlabbatch{3}.spm.util.imcalc.expression = '(i2+i3+i4).*i1'; %scull-stripped bias corrected
matlabbatch{3}.spm.util.imcalc.var = struct('name', {}, 'value', {});
matlabbatch{3}.spm.util.imcalc.options.dmtx = 0;
matlabbatch{3}.spm.util.imcalc.options.mask = 0;
matlabbatch{3}.spm.util.imcalc.options.interp = 1;
matlabbatch{3}.spm.util.imcalc.options.dtype = 4;spm('defaults','fmri');
spm_jobman('initcfg');
